...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
     ...
     * The sidebar passes only its column state 鈥?it holds no settings state.
     */
    ...
    /**
     * Optional entries between the New Session button and the browsing
     * region, e.g. a composed flow's dedicated entry. Declared by this
     * package's 'sidebar' entry; each entry receives only the column state.
     */
...
/**
 * Owner share of the browser hole 鈥?the only facts crossing the shell/region
...
/** Owner share of an entry rendered below the New Session button. */
...
export type SidebarRootComponentProps =
  ...
  & PropsRenderSlots<'sidebar.workspaces' | 'sidebar.settings' | 'sidebar.footer.action' | 'sidebar.newSession.action'>
