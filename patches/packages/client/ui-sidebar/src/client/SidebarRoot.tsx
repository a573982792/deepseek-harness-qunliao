 ...
 * while the sliding column (AppFrame grid tracks) clips it 鈥?nothing reflows
 ...
 * edge 鈥?on the way to the conversation, or around a portalled menu.
 */
...
export function SidebarRoot({
  ...
  // panel 鈥?or onto the conversation once it closes 鈥?fires no `pointerleave`
  ...
  return (
    ...
    >
      ...
      {/* Expanded, the button carries its own label 鈥?tooltip only on the rail. */}
      ...
      {/* Optional composed entries directly below New Session (e.g. a group-chat entry). */}
      <div className={css.newSessionActions}>
        {renderSlot('sidebar.newSession.action', { wide })}
      </div>
